...
export default function GameScreen({ vsComputer, onExit, onRunOver }) {
  ...
  useEffect(() => {
    ...
    const flavorText = isAIWin ? bags.current.flavorLose.pick() : bags.current.flavorWin.pick();
  ...
  function doMove(r, c) {
    setGame((prev) => {
      ...
      if (vsComputer && prev.currentPlayer === "X" && prev.heartCoord === placedKey && heartsRef.current < MAX_HEARTS) {
    ...
    <div className="game-container">
      ...
      {vsComputer && (
        <div className="game-meta-row">
          <HeartsDisplay hearts={hearts} maxHearts={MAX_HEARTS} animate={heartAnimate} />
      ...
      <Controls onAgain={handleAgain} onResetScore={handleResetScore} onExit={handleExit} />
